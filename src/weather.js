...
function locationSuccess(pos) {
  ...
  var url = "http://api.openweathermap.org/data/2.5/weather?lat=" +
      pos.coords.latitude + "&lon=" + pos.coords.longitude + '&appid=' + localStorage['openweathermap-api-key'];
...
Pebble.addEventListener('showConfiguration', function(e) {
  // Show config page
  Pebble.openURL('https://rawgit.com/idiotandrobot/inr-dos/master/config/index.html');
});
